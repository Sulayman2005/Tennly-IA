...
<template>
  <section class="comparateur">
    <div class="page-head">
      <div class="eyebrow"><i></i>IA TENNIS · COMPARATEUR</div>
      <h1>Mets deux joueurs <span class="accent">face à face</span>.</h1>
      <p class="subtitle">Comparaison Elo instantanée dès que les deux joueurs sont choisis, puis une analyse IA complète à la demande — probabilité, confiance et facteurs d'explication.</p>
    </div>
